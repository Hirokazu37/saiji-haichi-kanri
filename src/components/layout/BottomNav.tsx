...
const allTabs: Tab[] = [
  ...
  { label: "メニュー", href: "/menu", icon: MoreHorizontal, match: (p) => p.startsWith("/menu") || p.startsWith("/hotels") || p.startsWith("/applications") || p.startsWith("/dm") || p.startsWith("/customers") || p.startsWith("/payments") || p.startsWith("/sales") || p.startsWith("/payer-master") || p.startsWith("/venue-master") || p.startsWith("/area-master") || p.startsWith("/hotel-master") || p.startsWith("/employees") || p.startsWith("/agencies") || p.startsWith("/users"), roles: ["admin", "viewer", "limited"] },
];
