...
社長への報告（月次または年間まとめ）として分かりやすい解説を日本語で書きます。
payload の「対象」が月なら月次報告、年なら年間総括として、その粒度に合わせて書きます。
年間まとめのときは、月ごとの波（強い月・弱い月）と百貨店別の傾向、年計の前年比に重点を置きます。
...
- 「分母」はヒット率の分母で、DM枚数（発送枚数）か名簿人数のどちらか。payload の「分母種別」に従う。
  「ヒット率」＝ 来場者数 ÷ 分母 で、DMがどれだけ来店に結びついたかを表す
